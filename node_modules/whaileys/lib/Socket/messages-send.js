...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, useUserDevicesCache, statusJidList }) => {
        ...
        const destinationJid = isStatus
            ? statusJid
            : (0, WABinary_1.jidEncode)(user, isGroup ? "g.us" : isLid ? "lid" : "s.whatsapp.net");
        ...
        await authState.keys.transaction(async () => {
            ...
            if (isGroupOrStatus && !isRetryResend) {
                ...
                const { user: meLidUser } = (0, WABinary_1.jidDecode)(meLid);
                ...
                for (const { user, device } of devices) {
                    ...
                    const jid = (0, WABinary_1.jidEncode)(isMe && isLid && meLidUser ? meLidUser : user, isLid ? "lid" : "s.whatsapp.net", device);
                    if (isMe) {
                        meJids.push(jid);
                    }
                    else {
            ...
            if (participants.length) {
                if ((additionalAttributes === null || additionalAttributes === void 0 ? void 0 : additionalAttributes["category"]) === "peer") {
                    const peerNode = (_b = (_a = participants[0]) === null || _a === void 0 ? void 0 : _a.content) === null || _b === void 0 ? void 0 : _b[0];
                    if (peerNode) {
